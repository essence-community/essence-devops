...
import { PipelineHistoryService } from '../../services/project/PipelineHistoryService';
import { LogService } from '../../services/LogService';

const logger = Logger.getLogger('PipelineController');

@Controller('project/pipeline/history')
export class PipelineHistoryController {
    constructor(private readonly provider: PipelineHistoryService, private readonly audit: LogService) {}
        ...
        if(json.service) {
            ...
            try {
                ...
                this.audit.log({
                    ...
                    cv_method: 'project/pipeline/history',
