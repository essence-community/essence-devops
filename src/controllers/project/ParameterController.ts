import {ParameterService} from '../../services/project/ParameterService';
...
const logger = Logger.getLogger('ParameterController');

@Controller('project/parameter')
export class ParameterController {
    constructor(private readonly provider: ParameterService, private readonly audit: LogService) {}
